...
class AppColors {
  ...
  static const Color primaryColor = Color(0xFF00D4FF); // Light Blue/Cyan
  static const Color secondaryColor = Color(0xFF00A8FF); // Blue

  // Status Colors
  static const Color successColor = Color(0xFF00FF88); // Green
  static const Color successColorDark = Color(0xFF00AA55); // Darker Green
  static const Color warningColor = Color(0xFFFFB800); // Orange/Yellow
  ...
  static const Color powerOffGradientStart = Color(0xFF2A2A2A);
  static const Color powerOffGradientEnd = Color(0xFF1A1A1A);
  static const Color deleteIconColor = Colors.redAccent;
}
